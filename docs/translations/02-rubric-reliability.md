...
*From Challenges in Evaluating AI Systems (Anthropic, 2023) to the four-part reliability certification*

**Research finding:** A rubric is only as good as the consistency with which it is applied. If two independent judges score the same response differently, the rubric measures their subjectivity rather than the response quality.
